	...
	class AS3CF_Compatibility_Check {
		...
		public function get_sdk_requirements_errors() {
			...
			if ( version_compare( PHP_VERSION, '5.5', '<' ) ) {
				$errors[] = __( 'a PHP version less than 5.5', 'as3cf-assets' );
			}
		...
		public function get_sdk_error_msg() {
			...
			$msg = __( 'The official Amazon&nbsp;Web&nbsp;Services SDK requires PHP 5.5+ and cURL 7.16.2+ compiled with OpenSSL and zlib. Your server currently has', 'as3cf-assets' );
